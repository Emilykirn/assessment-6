...
const drawFive = () => {
    axios.get('https://ec2-54-191-238-107.us-west-2.compute.amazonaws.com/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('https://ec2-54-191-238-107.us-west-2.compute.amazonaws.com/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('https://ec2-54-191-238-107.us-west-2.compute.amazonaws.com/api/player')
...
const getAllBots = () => {
    axios.get('https://ec2-54-191-238-107.us-west-2.compute.amazonaws.com//api/robots')
        .then(({data}) => {
